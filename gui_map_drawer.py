...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_html_map.addWidget(self.lineEdit_save_html, 1, 5, 1, 1)
        self.graphicsView_html_map = QtWidgets.QGraphicsView(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.graphicsView_html_map.sizePolicy().hasHeightForWidth())
        self.graphicsView_html_map.setSizePolicy(sizePolicy)
        self.graphicsView_html_map.setObjectName("graphicsView_html_map")
        self.gridLayout_html_map.addWidget(self.graphicsView_html_map, 6, 0, 1, 6)
        ...
        self.gridLayout_html_map.addItem(spacerItem, 0, 4, 1, 1)
        self.gridLayout.addLayout(self.gridLayout_html_map, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.graphicsView_png_map, 0, 1, 1, 1)
